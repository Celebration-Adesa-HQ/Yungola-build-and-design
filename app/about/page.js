    ...
    <>
      ...
      <section className="relative min-h-[65vh] flex items-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12 pt-32 pb-20">
          ...
          <h1 className="text-5xl lg:text-8xl font-900 text-white max-w-3xl" style={{ fontFamily: "var(--font-cinzel)", fontWeight: 900 }}>About Yungola</h1>
      ...
      <section className="section-pad bg-[#F9F9F7]">
        <div className="max-w-7xl mx-auto px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <h2 className="text-4xl lg:text-6xl font-700 text-[#0D0D0D] mb-8 yellow-underline" style={{ fontFamily: "var(--font-cinzel)" }}>Mission & Vision</h2>
      ...
      <section className="section-pad bg-[#0D0D0D] relative overflow-hidden" aria-labelledby="why-heading">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10">
          ...
          <h2 id="why-heading" className="text-4xl lg:text-6xl font-700 text-white mb-14" style={{ fontFamily: "var(--font-cinzel)" }}>Why Choose Us</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {reasons.map(({ Icon, title, desc }) => (
              <div key={title} className="group p-6 border border-white/8 rounded-sm hover:border-[#F5C518]/40 transition-colors duration-300 relative">
                ...
                <h3 className="text-base font-600 text-white mb-2" style={{ fontFamily: "var(--font-cinzel)" }}>{title}</h3>
      ...
      <section className="section-pad bg-[#F9F9F7]" aria-labelledby="team-heading">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          <h2 id="team-heading" className="text-4xl lg:text-6xl font-700 text-[#0D0D0D] mb-14 yellow-underline" style={{ fontFamily: "var(--font-cinzel)" }}>Our Team</h2>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
            {team.map(({ name, role, image, alt }) => (
              <div key={name} className="group text-center">
                ...
                <h3 className="text-lg font-600 text-[#0D0D0D]" style={{ fontFamily: "var(--font-cinzel)" }}>{name}</h3>
      ...
      <section className="section-pad bg-[#1A1A1A]" aria-labelledby="timeline-heading">
        <div className="max-w-4xl mx-auto px-6 lg:px-12">
          ...
          <h2 id="timeline-heading" className="text-4xl lg:text-5xl font-700 text-white mb-14" style={{ fontFamily: "var(--font-cinzel)" }}>Milestones</h2>
              ...
              {milestones.map(({ year, title, desc }) => (
                <div key={year} className="flex items-start gap-6">
                  <div className="w-16 flex-shrink-0 text-right">
                    <span className="text-[#F5C518] text-sm font-700" style={{ fontFamily: "var(--font-cinzel)" }}>{year}</span>
                  </div>
