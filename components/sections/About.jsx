...
export default function About() {
  ...
  return (
    <section
      ref={ref}
      id="about"
      className="relative py-24 bg-acrino-darker border-y border-acrino-border overflow-hidden"
    >
      <div className="container mx-auto px-4 md:px-8 max-w-7xl">
        <div className="flex flex-col lg:flex-row relative items-center">
          ...
          {/* Text Box Overlay */}
          <div
            className={`w-full lg:w-1/2 lg:absolute lg:top-1/2 lg:-translate-y-1/2 lg:left-0 z-10 mt-[-100px] lg:mt-0 p-8 md:p-12 bg-[#2d3136] shadow-2xl transition-all duration-1000 delay-300 transform relative ${
              visible
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold uppercase tracking-wider mb-6 text-white font-oswald">
              About Yungola
            </h2>
            <div className="text-acrino-light text-sm md:text-base leading-relaxed space-y-6 font-montserrat font-light">
              <p>
            ...
            <a
              className="inline-flex items-center mt-10 px-8 py-3 bg-acrino-gold hover:bg-acrino-gold-dark text-white text-xs font-bold tracking-[0.1em] uppercase transition-all duration-300 transform hover:scale-105 active:scale-95 font-montserrat group"
              href="/about"
            >
              Read More
              <svg
