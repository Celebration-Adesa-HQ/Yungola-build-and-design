...
export const PAGE_SEO = {
  ...
  about: {
    title: "About Yungola | Our Story, Team & Mission | Luxury Architecture Nigeria",
    description:
  ...
  services: {
    title: "Our Services | 3D Design, Construction & Architecture | Yungola",
    description:
  ...
  gallery: {
    title: "Portfolio | Cinematic Architecture & Construction Projects | Yungola",
    description:
  ...
  contact: {
    title: "Contact Us | Consult with Yungola Build and Design | Lagos Nigeria",
    description:
